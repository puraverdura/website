...
<Container>
	<div class="page-content-row">
		<h1>Pura Verdura Sozial – Gemeinsam für mehr Zugang zu gesundem Gemüse</h1>
	</div>
	<div class="page-content-row">
	...
	<div class="page-content-row">
		...
		<p>In der aktuellen Saison (2025/2026) konnten wir dank der Unterstützung von Spender:innen und Organisationen bereits <strong>19 vergünstigte Gemüseabos</strong> an KulturLegi-Besitzer:innen vergeben.</p>
	</div>
	<div class="page-content-row">
		<h2>Wie du helfen kannst</h2>
		<p>Damit wir unser Angebot ausbauen und langfristig aufrechterhalten können, sind wir auf weitere Spenden angewiesen. Mit deiner Unterstützung können wir noch mehr Menschen erreichen und ihnen den Zugang zu frischem, regionalem Bio-Gemüse ermöglichen.</p>
		<p><strong>Jede Spende zählt!</strong> Bereits mit einem kleinen Beitrag kannst du einen grossen Unterschied machen.</p>
	</div>
	<div class="page-content-row">
