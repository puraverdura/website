...
<svelte:head>
	<title>Wie du mitmachen kannst - Pura Verdura</title>
	<meta
		name="description"
		content="Auf der Suche nach einem Bio-Gemüseabo in der Stadt Zürich? Dann bist du
...
<Container>
	...
	<div class="page-content-row">
		...
		<p>
			...
			4 Stunden oder 16 kleinen Einsätzen à 2 Stunden.
		</p>
		<p>
			<strong>Kleine Einsätze</strong> von 2 Stunden werden je nach Bedarf
			und Wetter am Mittwoch, Freitag und Samstag für die „allgemeine Mitarbeit
			auf dem Acker“ angeboten und im Sommer als „Feierabendeinsatz“.
		</p>
		<p>
		...
		<p>
			Idealerweise werden rund zwei Drittel der Einsätze zwischen April
	...
	<div class="page-content-row">
		<h2>Schnuppertage</h2>
		<p>
			Komm vorbei und lerne uns kennen! An einem Schnuppertag kannst Du
			einen Einblick in unsere Arbeit gewinnen und direkt mit anpacken.
			Melde Dich für einen Schnuppermorgen oder -nachmittag an: <a
