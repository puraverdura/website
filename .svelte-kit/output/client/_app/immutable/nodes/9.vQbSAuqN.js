import{t as o,a}from"../chunks/BMMGiry5.js";import"../chunks/C_CDBtmz.js";import{$ as m,s,i as g,j as d,k as u}from"../chunks/0OF3C7ta.js";import{h as p}from"../chunks/D7E0pRCa.js";import{C as v,P as f}from"../chunks/D7EHeW3j.js";import{C as w}from"../chunks/DIR38VeV.js";var k=o(`<meta name="description" content="Auf der Suche nach einem Bio-Gemüseabo in der Stadt Zürich? Dann bist du
		...
		Pura Verdura werden? Mitmachen ist ganz einfach!">`),b=o(`<div class="page-content-row"><h1>Wie du mitmachen kannst</h1> <p>Auf der Suche nach einem Bio-Gemüseabo in der Stadt Zürich? Dann
			...
			Melde Dich für einen Schnuppermorgen oder -nachmittag an: <a href="mailto:gemuese@puraverdura.ch">gemuese@puraverdura.ch</a>. Wir freuen uns, Dich kennenzulernen!</p> <div class="page-content-row"><h2>Du hast noch Fragen? Kontaktiere uns.</h2> <p>Wir stehen dir bei Fragen gerne zu Verfügung. Schreibe uns ein
				Mail an: <a href="mailto:miglieder@puraverdura.ch">miglieder@puraverdura.ch</a></p></div></div> <div class="page-content-row"><!></div> <div class="page-content-row"><!></div>`,1);function G(h){p(e=>{var i=k();m.title="Wie du mitmachen kannst - Pura Verdura",a(e,i)}),w(h,{children:(e,i)=>{var r=b(),n=s(g(r),8),c=d(n);v(c),u(n);var t=s(n,2),l=d(t);f(l,{pages:[{title:"Wieviel es kostet",link:"/wieviel-es-kostet/"},{title:"Wer dahinter steht",link:"/wer-dahinter-steht/"},{title:"Wo wir zu Hause sind",link:"/wo-wir-zu-hause-sind/"},{title:"Warum das eine gute Sache ist",link:"/warum-das-eine-gute-sache-ist/"}]}),u(t),a(e,r)}})}export{G as component};
