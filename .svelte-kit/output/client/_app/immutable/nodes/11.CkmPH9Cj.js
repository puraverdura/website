import{h as m,t as o,a}from"../chunks/dwKfIkCS.js";import"../chunks/B4m-3dG_.js";import{$ as g,s,f as p,c as d,r as u}from"../chunks/CHaHypBP.js";import{C as f,P as v}from"../chunks/BGDKXjoA.js";import{C as w}from"../chunks/DEKR1A2Q.js";var b=o(`<meta name="description" content="Auf der Suche nach einem Bio-Gemüseabo in der Stadt Zürich? Dann bist du
		...
		Pura Verdura werden? Mitmachen ist ganz einfach!">`),k=o(`<div class="page-content-row"><h1>Wie du mitmachen kannst</h1> <p>Auf der Suche nach einem Bio-Gemüseabo in der Stadt Zürich? Dann
			...
			möchtest Teil von Pura Verdura werden? Mitmachen ist ganz einfach!</p> <img src="/content/Feld.jpg" alt="Mitglieder auf dem Feld am Karotten ernten"></div> <div class="page-content-row"><h2>Genossenschafter:in werden</h2> <p>Mit dem Erwerb eines Anteilsscheins im Wert von CHF 500 wirst du
			...
			Melde Dich für einen Schnuppermorgen oder -nachmittag an: <a href="mailto:gemuese@puraverdura.ch">gemuese@puraverdura.ch</a>. Wir freuen uns, Dich kennenzulernen!</p></div> <div class="page-content-row"><h2>Du hast noch Fragen? Kontaktiere uns.</h2> <p>Wir stehen dir bei Fragen gerne zu Verfügung. Schreibe uns ein
				Mail an: <a href="mailto:miglieder@puraverdura.ch">miglieder@puraverdura.ch</a></p></div> <div class="page-content-row"><!></div> <div class="page-content-row"><!></div>`,1);function E(h){m(e=>{var i=b();g.title="Wie du mitmachen kannst - Pura Verdura",a(e,i)}),w(h,{children:(e,i)=>{var r=k(),n=s(p(r),10),c=d(n);f(c),u(n);var t=s(n,2),l=d(t);v(l,{pages:[{title:"Wieviel es kostet",link:"/wieviel-es-kostet/"},{title:"Wer dahinter steht",link:"/wer-dahinter-steht/"},{title:"Wo wir zu Hause sind",link:"/wo-wir-zu-hause-sind/"},{title:"Warum das eine gute Sache ist",link:"/warum-das-eine-gute-sache-ist/"}]}),u(t),a(e,r)}})}export{E as component};
