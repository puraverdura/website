import { n as head, k as ensure_array_like, f as attr, l as escape_html } from "../../../chunks/index.js";
...
function _page($$payload) {
  const bgMembers = [
    ...
    },
    {
      ...
      image: "Emilia.png",
      description: "Emilia studiert Umweltnaturwissenschaften und interessiert sich für alles, was mit Essen zu tun hat - vom Anbau über die Verarbeitung bis hin zum Konsum. Sie möchte ihren Teil zu einer nachhaltigen Lebensmittelproduktion und einem bewussten Konsum beitragen. Am wohlsten fühlt sie sich, wenn sie mit den Händen arbeitet: in der Küche, im Garten oder an der Töpferscheibe."
    }
  ];
