...
return {
	...
	_: {
		...
		prerendered_routes: new Set(["/","/__data.json","/netzwerk/","/wer-dahinter-steht/","/wo-wir-zu-hause-sind/","/was-wir-tun/","/wie-du-mitmachen-kannst/","/warum-das-eine-gute-sache-ist/","/wieviel-es-kostet/","/site-not-found/","/agenda/","/agenda/__data.json","/sozial/","/impressum/","/impressum/__data.json","/datenschutz/","/datenschutz/__data.json"]),
		matchers: async () => {
